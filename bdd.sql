IF EXISTS DROP TABLE BOS;
IF EXISTS DROP TABLE login;
IF EXISTS DROP TABLE Stage;
IF EXISTS DROP TABLE Commentaire;
IF EXISTS DROP TABLE Document;
IF EXISTS DROP TABLE Tuteur;
IF EXISTS DROP TABLE Etudiant;
IF EXISTS DROP TABLE Personnel;
IF EXISTS DROP TABLE Formation;
IF EXISTS DROP TABLE Entreprise;
